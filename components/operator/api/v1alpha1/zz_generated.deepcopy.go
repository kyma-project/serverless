...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PersistanceVolume) DeepCopyInto(out *PersistanceVolume) {
	*out = *in
	if in.Size != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PersistanceVolume.
func (in *PersistanceVolume) DeepCopy() *PersistanceVolume {
	if in == nil {
		return nil
	}
	out := new(PersistanceVolume)
