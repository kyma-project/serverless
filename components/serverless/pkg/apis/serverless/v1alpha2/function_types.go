...
type FunctionSpec struct {
	...
	// This setting should be removed from a future version, serverless will no longer automatically create HPA.
...
//+kubebuilder:resource:categories={kyma-serverless}
