...
JobInit is used as the init container for injecting a Git repository to the [Job that builds a Function](https://kyma-project.io/external-content/serverless/docs/user/technical-reference/07-20-function-processing-stages).
