...
type config struct {
	...
	Nodejs20Image   string `envconfig:"default=europe-docker.pkg.dev/kyma-project/prod/function-runtime-nodejs20:main"`
	Python312Image  string `envconfig:"default=europe-docker.pkg.dev/kyma-project/prod/function-runtime-python13:main"`
}
...
func main() {
	...
	fnRecon := controllers.NewFunctionReconciler(mgr.GetClient(), l, controllers.ReconcilerConfig{
		Nodejs20Image:  cfg.Nodejs20Image,
		Python312Image: cfg.Python312Image,
	})
