...
func Test_functionValidator_validateRuntime(t *testing.T) {
	...
	for _, runtime := range []serverlessv1alpha2.Runtime{serverlessv1alpha2.NodeJs22, serverlessv1alpha2.NodeJs24, serverlessv1alpha2.NodeJs26, serverlessv1alpha2.Python312, serverlessv1alpha2.Python314} {
