...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	...
	$(CONTROLLER_GEN) rbac:roleName=operator-role crd webhook paths="./components/operator/api/..." paths="./components/operator/controllers/..." output:crd:artifacts:config=$(CONFIGOPERATOR)/crd/bases output:rbac:artifacts:config=$(CONFIGOPERATOR)/rbac
