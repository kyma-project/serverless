...
.PHONY: docker-build
docker-build: module-chart ## Build docker image with the manager.
	docker build -t ${IMG} .
...
.PHONY: docker-buildx
docker-buildx: module-chart ## Build and push docker image for the manager for cross-platform support
...
# TODO: $(KUSTOMIZE) edit set image controller=${IMG} is not working fix it
# TODO: create ns
