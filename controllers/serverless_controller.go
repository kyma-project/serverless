...
//+kubebuilder:rbac:groups=apps,resources=daemonsets,verbs=get;create;update;patch
...
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterroles;clusterrolebindings,verbs=get;create;update
...
//+kubebuilder:rbac:groups=serverless.kyma-project.io,resources=gitrepositories,verbs=get;list;watch;create
//+kubebuilder:rbac:groups=serverless.kyma-project.io,resources=gitrepositories/status,verbs=get

//+kubebuilder:rbac:groups=networking.istio.io,resources=destinationrules,verbs=get;create;update
//+kubebuilder:rbac:groups=networking.istio.io,resources=virtualservices,verbs=get;create;update
...
//+kubebuilder:rbac:groups=admissionregistration.k8s.io,resources=validatingwebhookconfigurations;mutatingwebhookconfigurations,verbs=get;list;watch;create;update;delete
