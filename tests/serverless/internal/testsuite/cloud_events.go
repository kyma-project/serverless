...
func FunctionCloudEventsFIPS(restConfig *rest.Config, cfg internal.Config, logf *logrus.Entry) (executor.Step, error) {
	...
	return executor.NewSerialTestRunner(logf, "Runtime test",
		...
		function.CreateFunction(logf, publisherProxyMock, "Create publisher proxy mock", runtimes.NodeJSPublishingProxyMock(serverlessv1alpha2.NodeJs26)),
		executor.NewParallelRunner(logf, "Fn tests",
			...
			executor.NewSerialTestRunner(nodejs22Logger, "NodeJS22 test",
				function.CreateFunction(nodejs22Logger, nodejs22Fn, "Create NodeJS22 Function", runtimes.NodeJSFunctionWithCloudEventLegacy(serverlessv1alpha2.NodeJs22)),
			...
			executor.NewSerialTestRunner(nodejs24Logger, "NodeJS24 test",
				function.CreateFunction(nodejs24Logger, nodejs24Fn, "Create NodeJS24 Function", runtimes.NodeJSFunctionWithCloudEventLegacy(serverlessv1alpha2.NodeJs24)),
	...
	return executor.NewSerialTestRunner(logf, "Runtime test",
		...
		executor.NewParallelRunner(logf, "Fn tests",
			executor.NewSerialTestRunner(python312Logger, "Python312 test",
				function.CreateFunction(python312Logger, python312Fn, "Create Python312 Function", runtimes.PythonCloudEventLegacy(serverlessv1alpha2.Python312)),
			...
			executor.NewSerialTestRunner(nodejs20Logger, "NodeJS20 test",
				function.CreateFunction(nodejs20Logger, nodejs20Fn, "Create NodeJS20 Function", runtimes.NodeJSFunctionWithCloudEventLegacy(serverlessv1alpha2.NodeJs20)),
