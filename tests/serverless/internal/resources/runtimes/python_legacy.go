...
func BasicPythonFunctionLegacy(msg string, runtime serverlessv1alpha2.Runtime) serverlessv1alpha2.FunctionSpec {
...
func BasicTracingPythonFunctionLegacy(runtime serverlessv1alpha2.Runtime, externalURL string) serverlessv1alpha2.FunctionSpec {
...
func BasicPythonFunctionWithCustomDependencyLegacy(msg string, runtime serverlessv1alpha2.Runtime) serverlessv1alpha2.FunctionSpec {
	src := fmt.Sprintf(
		`import arrow
def main(event, context):
	return "%s"`, msg)
...
func PythonCloudEventLegacy(runtime serverlessv1alpha2.Runtime) serverlessv1alpha2.FunctionSpec {
	dpd := ``
