...
func (in *DockerRegistry) DeepCopyInto(out *DockerRegistry) {
	*out = *in
	...
	if in.InternalServerAddress != nil {
		in, out := &in.InternalServerAddress, &out.InternalServerAddress
		*out = new(string)
		**out = **in
	}
	...
	if in.GatewayCert != nil {
		in, out := &in.GatewayCert, &out.GatewayCert
		*out = new(string)
		**out = **in
	}
}
...
func (in *ServerlessSpec) DeepCopyInto(out *ServerlessSpec) {
	*out = *in
	if in.EventPublisherProxyURL != nil {
		in, out := &in.EventPublisherProxyURL, &out.EventPublisherProxyURL
		*out = new(string)
		**out = **in
	}
	if in.TraceCollectorURL != nil {
		in, out := &in.TraceCollectorURL, &out.TraceCollectorURL
		*out = new(string)
		**out = **in
	}
