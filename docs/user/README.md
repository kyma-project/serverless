...
- Exposed to an external endpoint (HTTPS). With an [APIRule CR](https://github.com/kyma-project/api-gateway/blob/main/docs/user/custom-resources/apirule/04-10-apirule-custom-resource.md), you can define who can reach the endpoint and what operations they can perform on it.
