...
| **runtime**                                                    |   Yes    | Function | | Specifies the execution environment for your Function. The available values are `nodejs18`, `nodejs20`, `python39` - deprecated, and `python312`.                                                                                                                                                                     |
