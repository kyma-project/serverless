...
- **Details**: Node.js 20 runtime was deprecated starting with version 1.10.0. For more information, see [Issue](https://github.com/kyma-project/serverless/issues/2231).



> **NOTE:** The deprecation and EOL dates listed in this document are **predictions based on current release cadence and Node.js/Python LTS schedules**. These dates are subject to change and may be adjusted based on:
