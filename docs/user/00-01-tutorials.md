...
- [Create a Git Function](/docs/user/03-11-create-git-function.md)
...
- [Set an external Docker registry](/docs/user/03-60-set-external-registry.md) 
- [Switch between registries at runtime](/docs/user/03-70-switch-to-external-registry.md)
