...
>**TIP:** See [sample Functions](https://github.com/kyma-project/kyma/blob/main/docs/05-technical-reference/svls-01-sample-functions.md) for each available runtime.
...
>**TIP:** Read more about [Git Functions](https://github.com/kyma-project/kyma/blob/main/docs/05-technical-reference/svls-04-git-source-type.md).