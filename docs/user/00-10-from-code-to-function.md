...
>**TIP:** See [sample Functions](technical-reference/07-10-sample-functions.md) for each available runtime.
...
>**TIP:** Read more about [Git Functions](technical-reference/07-40-git-source-type.md).