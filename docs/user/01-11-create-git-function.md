...
To learn more about Git repository sources for Functions and different ways of securing your repository, read about the [Git source type](07-40-git-source-type.md).
...
2. Create a Secret (optional).
    ...
    - Select **Add data entry** and enter these key-value pairs with credentials:
        ...
        >**NOTE:** Read more about the [supported authentication methods](07-40-git-source-type.md).
